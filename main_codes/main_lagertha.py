...
#Open AI parameter
openai.api_key = "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"
messages = []
...
model = Model(r"C:\Users\user\Documents\pythonFiles\speech_recognition\vosk-model-small-en-us-0.15\vosk-model-small-en-us-0.15")
...
identity_checking = True  # THIS ONE
identity_correct = False   #THIS ONE
time.sleep(1) 
...
while True:
    if identity_checking == True:
        while True:
            ...
            if faces != ():
                ...
                identity_checking = False
                identity_correct = True #fhakhfkhekfahfeiahf
                break
            else:
                #cmd = "no face\r"
                print('no face')
    ...
    if identity_correct == True:
        ...
        while True:
            ...
            #print(dataPacket)
            if dataPacket == 'identity_confirm':
                pygame.mixer.init()
    ...
    if message == None:
        ...
        if "information" in keyword_parameter:
            ...
            gpt = False
        if "send" in keyword_parameter or "whatsapp" in keyword_parameter or "phone" in keyword_parameter:
            ...
            gpt = False
        if "light" in keyword_parameter or "table" in keyword_parameter:
            gpt = False
            message = None
